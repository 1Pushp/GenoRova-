...
| Metric | Value |
| --- | ---: |
| Valid RDKit SMILES | 91 / 1000 |
| Validity | 9.1% |
| Unique valid molecules | 81 / 91 |
| Uniqueness among valid | 89.01% |
| Novel valid molecules | 69 / 91 |
| Novelty among valid | 75.82% |
| Novel unique molecules | 67 / 81 |
| Novelty among unique valid | 82.72% |
| Average clinical score (unique valid) | 0.84 |
...
| Metric | Value |
| --- | ---: |
| Unique valid candidate pool | 81 |
| Filtered computational candidates | 68 |
| Filter pass rate | 83.95% |
| Rejection reasons | `{'qed_below_threshold': 7, 'mw_out_of_range': 6, 'logp_out_of_range': 3, 'lipinski_fail': 2}` |
...
| NC1=CN2N=CC(N)=NC(N)=C2N=C1c1ccccc1 | 0.9031 | 0.6649 | 3.7413 | 267.3 | 0.033 | True | passed_all_filters |
...
| NC1=CN2N=CC(N)=NC(N)=C2N=C1c1ccccc1 | 0.9031 | Strong candidate | 0.6649 | 3.7413 | 267.3 | 0.033 |
...
- Top invalid reasons: `{'rdkit_parse_failure': 549, 'long_repetitive_fragment': 154, 'ring_closure_mismatch': 108, 'unbalanced_parentheses': 56, 'unbalanced_brackets': 42}`
- Invalid reason percentages: `{'rdkit_parse_failure': 60.4, 'long_repetitive_fragment': 16.94, 'ring_closure_mismatch': 11.88, 'unbalanced_parentheses': 6.16, 'unbalanced_brackets': 4.62}`
- Avg invalid length: `81.3179`
- Common invalid endings: `{'ccc1': 14, 'CCC1': 11, 'C)C1': 9, ')cc1': 8, '2)O1': 6, 'O)c1': 6, 'OCC1': 5, '1C#N': 5, 'C1C1': 5, '2)C1': 4}`
- Top decoded tokens: `{'C': 17826, 'c': 13233, '1': 6697, 'O': 6232, '(': 5875, ')': 5807, '2': 2825, '=': 2572, 'H': 2234, 'N': 2098}`
