...
- Top invalid reasons: `{'unbalanced_parentheses': 20, 'ring_closure_mismatch': 3, 'rdkit_parse_failure': 1, 'long_repetitive_fragment': 1}`
- Top decoded tokens: `{'c': 437, 'C': 155, ')': 75, '(': 56, '1': 35, 'O': 35, '2': 20, '=': 15, 'N': 14, 'n': 7}`
