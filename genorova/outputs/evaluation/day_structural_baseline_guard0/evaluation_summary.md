...
- Invalid reason percentages: `{'unbalanced_parentheses': 69.26, 'ring_closure_mismatch': 17.29, 'unbalanced_brackets': 7.79, 'rdkit_parse_failure': 3.74, 'long_repetitive_fragment': 1.92}`
- Avg invalid length: `42.2668`
- Common invalid endings: `{')cc1': 41, 'ccc1': 22, '2)c1': 16, 'CCCC': 15, 'O)c1': 11, 'CCC1': 10, ')CC1': 9, '=O)O': 8, 'C)C1': 7, 'l)c1': 7}`
